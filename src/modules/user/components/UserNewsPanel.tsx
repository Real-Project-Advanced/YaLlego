    ...
    <section id="novedades" className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <p className="text-xs font-bold uppercase text-emerald-700">News and updates</p>
          <h2 className="mt-1 text-xl font-black leading-tight text-slate-950">Mobility status</h2>
        </div>
